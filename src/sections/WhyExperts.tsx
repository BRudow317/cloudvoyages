      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-red-100 rounded-full mb-6">
            ...
            <span className="text-sm text-red-700">Critical Systems Need Expert Care</span>
          </div>
          <h2 className="text-4xl mb-4">Don't Risk Your Business on DIY Cloud Migration</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="space-y-6">
            <h3 className="text-3xl">The Real Cost of Going It Alone</h3>
            <div className="space-y-4">
              {riskFactors.map((factor, index) => (
                <Card key={index} className="p-4 border-l-4 border-red-500">
                  <div className="flex items-start gap-4">
                    <factor.icon className="w-6 h-6 text-red-600 flex-shrink-0 mt-1" />
                    <div className="flex-1">
                      <h4 className="mb-2">{factor.risk}</h4>
                      <div className="flex items-start gap-2 mb-2 text-sm">
                        <XCircle className="w-4 h-4 text-red-500 flex-shrink-0 mt-0.5" />
                        <span className="text-red-700">{factor.withoutExperts}</span>
                      </div>
                      <div className="flex items-start gap-2 text-sm">
                        <CheckCircle2 className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
                        <span className="text-green-700">{factor.withExperts}</span>
                      </div>
                    </div>
                  </div>
                </Card>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg">
          <h3 className="text-2xl mb-6 text-center">What Our Expert Team Handles for You</h3>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="text-5xl mb-3">🔍</div>
              <h4 className="mb-2">Assessment & Planning</h4>
            ...
            <div className="text-center">
              <div className="text-5xl mb-3">🚀</div>
              <h4 className="mb-2">Zero-Downtime Migration</h4>
              <p className="text-sm text-gray-600">
            ...
            <div className="text-center">
              ...
              <h4 className="mb-2">Ongoing Optimization</h4>
              <p className="text-sm text-gray-600">
