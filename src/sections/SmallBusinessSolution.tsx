    ...
    <section className="py-20 bg-gradient-to-br from-purple-50 via-blue-50 to-cyan-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl mb-4">Small Business? We've Got You Covered</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          <div className="space-y-6">
            <h3 className="text-3xl">Turn Your Website Into a Lead Generation Machine</h3>
        ...
        <div className="mb-12">
          <h3 className="text-3xl text-center mb-12">Choose Your Growth Plan</h3>
          <div className="grid md:grid-cols-3 gap-6">
            {packages.map((pkg, index) => (
              <Card 
                key={index} 
                className={`p-6 relative ${pkg.popular ? 'border-2 border-blue-500 shadow-xl' : ''}`}
              >
                {pkg.popular && (
                ...
                <div className="text-center mb-6">
                  ...
                  <div className="text-gray-600 text-sm">{pkg.period}</div>
